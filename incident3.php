    ...
    <header class="header">
       ...
       <h1 style="font-size: 60px">United As One</h1>
        ...
        <div id="menu">
            ...
            <a href="incident3.php#footer">About Us </a>
